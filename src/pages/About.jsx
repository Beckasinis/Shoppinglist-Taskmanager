  ...
  return (
    <div className="container">
      ...
      <div className="glass-card">
        ...
        I have used React with Vite and it uses localStorage to save things. It uses useState, useEffect, useContext och React Router.</p>
      <div className="glass-card">
        <h2>The focus!</h2>
        <p>My sister maybe have an odd way of shopping her groceries. Or she is like many other people, I don't know. But her
          analog list is very systematic written. She writes everything what she will buy in order after the way the shop have
          their things. So that she can go from top to bottom buying what she will have from her list.</p>

        <p>So that's the idea of this app. I wanted to build something what would make it easy for her to implement her
      ...
      <div className="glass-card">
        ...
        <p>I have put the last one called 'Other' to put things what don't match in any other section.
          ...
          the top. All is sorted in alphabetic order.</p>
        ...
        <p>I have also choosen to make a manual reminder if you have cupons or deposit from bottles. If you have it you push the
          ...
          so I choose to make it manual instead of letting the reminder come when all in the list is marked as done.</p>
      </div>
      <div className="glass-card">
        <h2>The task-manager</h2>
        <p>The task-manager was my very first thing what I made as a learning project of React. You are able to put your tasks in the
          ...
          tasks by the searchfield.</p>

        <p>I have put this onto my GitHub Pages so that I myself can use it and also my sister, and others. Before I, in my next project
          course will make some improvements on it. As a matter of fact, I have plans to make it much more advanced then this one is.</p>
